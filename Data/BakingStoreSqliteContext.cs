...
public class BakingStoreSqliteContext
{
    ...
    async Task InitDb()
	{
        ...
        await _asyncContext.ExecuteAsync("CREATE VIEW IF NOT EXISTS VBakingPlanningTopping AS SELECT b.*, t.Name AS ToppingName, t.UomCode AS ToppingUomCode, t.AvailableStock AS ToppingAvailableStock FROM BakingPlanTopping b JOIN Topping t ON b.ToppingId = t.Id;");
